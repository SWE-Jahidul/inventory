  ...
  return (
    <div className="bg-[#e2e0e03a]">
      <div className="flex justify-between py-3 px-3">
          <h1 className="text-2xl font-semibold text-black font-Poppins">Orders</h1>
          <div className="flex ml-10 items-center justify-end rounded-md border md:w-96 sm:w-44 bg-white px-3 cursor-pointer">
            ...
            <input
              className="bg-white w-11/12 font-Poppins text-black outline-none"
              type="text"
              id="search"
              value={searchQuery}
      ...
      >
        <table className="text-center table-auto table rounded-none bg-white font-Poppins sm:w-3/12 md:w-full">
          <thead>
          ...
          <tbody>
            {filteredProducts.map((product) => (
              <tr className="font-semibold text-p-purple even:bg-gray-200" key={product._id}>
                ...
                <td className="border-y py-1 font-semibold">
                  <span
                ...
                <td className="border-y py-1 font-normal">{product.total_qty}</td>
                <td className="border-y py-1 font-normal">{product.status}</td>
                <td className="border-y py-1 font-normal">{product.customer_name}</td>
                <td className="border-y text-center py-1 w-40 font-normal">
